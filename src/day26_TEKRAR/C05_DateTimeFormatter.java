...
public class C05_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        /*
            ...
            ancak bizim istedigimiz formata uygun olarak cevirmemize
            veya yazdirmamiza izin verir.
        ...
        */
        ...
        System.out.println(ldt.format(dtf2)); // Cuma 03:56

        DateTimeFormatter dtf3 = DateTimeFormatter.ofPattern("EEEE hh:mm a");
        System.out.println(ldt.format(dtf3)); // Cuma 03:57 ÖÖ
