...
public class C01 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(b); b' ye ulasamiyorum, sadece access modifier' la karar vermiyoruz staticle beraber bakıyoruz.
        System.out.println(c); // c' ye ulasabiliyorum

        //  str = "Java"; // cunku str static degil ama icinde oldugu main method static oldugu icin
        s = "Hava";
